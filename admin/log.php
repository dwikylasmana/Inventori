...
$result = mysqli_query($koneksi, "SELECT * FROM log_msk");
$result2 = mysqli_query($koneksi, "SELECT * FROM log_klr");
		                ...
		                <li>
		                	...
		                	<div class="collapsible-body">
		                		<ul>
									...
									<li><a href="log.php">Log Data</a></li>
								</ul>
							</div>
		                </li>
					...
					<table class="highlight">
						<table class="highlight">
							...
							while($user_data2 = mysqli_fetch_array($result2)) { 
				                echo "<tr>";
			                    echo "<td>".$user_data2['kejadian']."</td>";
				                echo "<td>".$user_data2['waktu']."</td>";
								echo "</tr>";
				            }
