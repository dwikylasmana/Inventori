...
$result = mysqli_query($koneksi, "CALL getGabung();");
	        ...
	        <nav class="row top-nav red darken-2">
	    		<div class="container">
	    			<div class="col offset-l2 nav-wrapper">
	    				...
	    				<a class="page-title">Hasil Pengiriman</a>
	    			</div>
	    		</div>
			</nav>
					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							<tr>
								...
								<th hidden>Nama Barang</th>
								<th>Tujuan Diterima</th>
								<th>Tanggal</th>
								<th>Operator</th>
				            </tr>
							...
							while($user_data = mysqli_fetch_array($result)) { 
								...
								echo "<td hidden>".$user_data['id']."</td>";
								echo "<td hidden>".$user_data['kode_barang']."</td>";
								echo "<td hidden>".$user_data['nama_barang']."</td>";
